...
//  MyApp
//
//  Created by Byron ZHU on 2019/7/27.
//  Copyright © 2019 Facebook. All rights reserved.
//

#import "ByronKeyBoard.h"
#import <React/RCTUIManager.h>
#import <React/RCTBaseTextInputView.h>

@implementation ByronKeyboard
...
RCT_EXPORT_MODULE(ByronKeyBoard)

RCT_EXPORT_METHOD(install:(nonnull NSNumber *)reactTag withType:(nonnull NSString *)keyboardType)
{
  UIView* inputView = [[RCTRootView alloc] initWithBridge:_bridge moduleName:@"ByronKeyboard" initialProperties:
                       @{
                         @"tag": reactTag,
                         @"type": keyboardType
                         }
